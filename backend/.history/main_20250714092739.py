...
from database import get_db, Base, engine, User       # ← bring in User
from auth import get_password_hash                    # ← bring in the hasher
from schemas import UserCreate, UserOut               # ← your signup schemas
...
async def login(form_data: OAuth2PasswordRequestForm = Depends()):
    ...
    return {"access_token": access_token, "token_type": "bearer"}4
