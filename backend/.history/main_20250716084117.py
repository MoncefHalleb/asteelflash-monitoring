...
def defect_forecast(periods: int = 30, db: Session = Depends(get_db)):
    # Create an instance of the ForecastService and pass the db session
    forecast_service = ForecastService(db)
    
    # Now, use the instance to call the forecast method
    forecast = forecast_service.forecast(periods)
